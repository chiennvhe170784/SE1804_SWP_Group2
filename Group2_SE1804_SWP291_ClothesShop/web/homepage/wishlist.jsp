<%-- 
    Document   : wishlist
    Created on : 10/07/2024, 3:32:50 PM
    Author     : ADMIN
--%>
...
<body>
	...
	<!-- Start Wishlist Area -->
	<div class="wishlist-page pt-70 pb-70">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
                        ...
                        <table class="table table-bordered  align-middle text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="pro-quantity">Product in Stock</th>
                            ...
                            <tbody>
                               ...
                               <c:forEach var="p" items="${pList}">
                                                   <tr id="${p.pid}">
                                    <td class="pro-thumbnail"><a href="DetailProduct?pid=${p.pid}"><img class="img-fluid" src="${p.img}" alt="Product"></a></td>
